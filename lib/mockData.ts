...
export const generateAssetLiquidationData = (protocol: string = "aave-v3"): AssetLiquidationConfig[] => {
    const config = PROTOCOL_CONFIG[protocol] || PROTOCOL_CONFIG["aave-v3"];
    const multiplier = config.reserveMultiplier;

    // Different protocols have different risk parameters
    const ltvMultiplier = protocol === "compound" ? 0.9 : 1.0; // Compound is slightly more conservative
    const bonusMultiplier = protocol === "compound" ? 1.15 : 1.0; // Compound has higher liquidation bonuses

    return [
        {
            asset: "ETH",
            ltv: 0.825 * ltvMultiplier,
            liquidationThreshold: 0.86 * ltvMultiplier,
            liquidationBonus: 0.05 * bonusMultiplier,
            supplied: 350000000 * multiplier,
            borrowed: 245000000 * multiplier,
            utilization: 0.70,
        ...
        {
            asset: "WBTC",
            ltv: 0.70 * ltvMultiplier,
            liquidationThreshold: 0.75 * ltvMultiplier,
            liquidationBonus: 0.10 * bonusMultiplier,
            supplied: 280000000 * multiplier,
            borrowed: 196000000 * multiplier,
            utilization: 0.70,
            canBeCollateral: true,
            canBeBorrowed: true,
        },
        {
            asset: "USDC",
            ltv: 0.87 * ltvMultiplier,
            liquidationThreshold: 0.89 * ltvMultiplier,
            liquidationBonus: 0.045 * bonusMultiplier,
            supplied: 420000000 * multiplier,
            borrowed: 336000000 * multiplier,
            utilization: 0.80,
            canBeCollateral: true,
            canBeBorrowed: true,
        },
        {
            asset: "DAI",
            ltv: 0.77 * ltvMultiplier,
            liquidationThreshold: 0.80 * ltvMultiplier,
            liquidationBonus: 0.05 * bonusMultiplier,
            supplied: 180000000 * multiplier,
            borrowed: 126000000 * multiplier,
            utilization: 0.70,
            canBeCollateral: true,
            canBeBorrowed: true,
        },
        {
            asset: "USDT",
            ltv: 0.00, // Cannot be used as collateral in many protocols
            liquidationThreshold: 0.00,
            liquidationBonus: 0.00,
            supplied: 150000000 * multiplier,
            borrowed: 105000000 * multiplier,
            utilization: 0.70,
        ...
        {
            asset: "LINK",
            ltv: 0.65 * ltvMultiplier,
            liquidationThreshold: 0.70 * ltvMultiplier,
            liquidationBonus: 0.10 * bonusMultiplier,
            supplied: 80000000 * multiplier,
            borrowed: 56000000 * multiplier,
            utilization: 0.70,
            canBeCollateral: true,
            canBeBorrowed: true,
        },
        {
            asset: "AAVE",
            ltv: 0.60 * ltvMultiplier,
            liquidationThreshold: 0.70 * ltvMultiplier,
            liquidationBonus: 0.10 * bonusMultiplier,
            supplied: 45000000 * multiplier,
            borrowed: 22500000 * multiplier,
            utilization: 0.50,
            canBeCollateral: true,
            canBeBorrowed: true,
        },
        {
            asset: "UNI",
            ltv: 0.60 * ltvMultiplier,
            liquidationThreshold: 0.77 * ltvMultiplier,
            liquidationBonus: 0.10 * bonusMultiplier,
            supplied: 35000000 * multiplier,
            borrowed: 21000000 * multiplier,
            utilization: 0.60,
            canBeCollateral: true,
            canBeBorrowed: true,
        },
